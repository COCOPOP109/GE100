    ...
    <div className="h-screen w-full bg-slate-50 text-slate-900 overflow-hidden relative font-sans selection:bg-emerald-200 selection:text-emerald-900">
      ...
      <div className="h-full w-full overflow-y-auto snap-y snap-mandatory scroll-smooth snap-container">
        ...
        <Section id="home-impact" className="bg-[#F8FAFC] overflow-hidden relative">
          ...
          <div className="max-w-7xl mx-auto px-6 h-full flex flex-col justify-center relative z-10 py-8 md:py-12">
            
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10 lg:gap-20 items-center">
               
               {/* Left Column: Title & Staggered Stats */}
               <div className="lg:col-span-5 flex flex-col self-center w-full">
                  <div className="mb-6 md:mb-12 text-center md:text-left">
                     <div className="inline-block px-3 py-1 bg-emerald-50 text-emerald-700 text-[10px] md:text-xs font-bold rounded-full mb-2 md:mb-4 border border-emerald-100">IMPACT & VALUES</div>
                     <h2 className="text-3xl md:text-5xl font-bold text-slate-900 leading-[1.1] mb-2 md:mb-6 tracking-tight">
                       影响力与<br/>
                       <GradientText>核心价值</GradientText>
                     </h2>
                     <p className="text-slate-500 text-sm md:text-lg font-light leading-relaxed max-w-sm mx-auto md:mx-0">
                  ...
                  <div className="grid grid-cols-2 gap-3 md:gap-6 relative">
                      ...
                      <div className="space-y-3 md:space-y-6">
                         {/* Stat 1 */}
                         <div className="p-3 md:p-6 bg-white rounded-2xl rounded-tr-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-slate-100 hover:-translate-y-1 transition-transform duration-300 group">
                            <div className="flex justify-between items-start mb-2">
                               <Users className="w-4 h-4 md:w-5 md:h-5 text-emerald-100 group-hover:text-emerald-500 transition-colors" />
                               <ArrowUpRight className="w-3 h-3 md:w-4 md:h-4 text-slate-300" />
                            </div>
                            <div className="text-2xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-emerald-600 to-teal-600 mb-1">30<span className="text-emerald-500 text-lg md:text-2xl align-top">+</span></div>
                            <div className="text-[10px] md:text-sm text-slate-500 font-medium">零碳联盟专家</div>
                         </div>
                         {/* Stat 3 */}
                         <div className="p-3 md:p-6 bg-white rounded-2xl rounded-bl-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-slate-100 hover:-translate-y-1 transition-transform duration-300 group">
                             <div className="flex justify-between items-start mb-2">
                               <Building2 className="w-4 h-4 md:w-5 md:h-5 text-emerald-100 group-hover:text-emerald-500 transition-colors" />
                               <ArrowUpRight className="w-3 h-3 md:w-4 md:h-4 text-slate-300" />
                            </div>
                            <div className="text-2xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-emerald-600 to-teal-600 mb-1">10<span className="text-emerald-500 text-lg md:text-2xl align-top">+</span></div>
                            <div className="text-[10px] md:text-sm text-slate-500 font-medium">早期成员单位</div>
                         </div>
                      </div>

                      <div className="space-y-3 md:space-y-6 md:pt-12">
                         {/* Stat 2 */}
                         <div className="p-3 md:p-6 bg-white rounded-2xl rounded-tl-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-slate-100 hover:-translate-y-1 transition-transform duration-300 group">
                             <div className="flex justify-between items-start mb-2">
                               <FileText className="w-4 h-4 md:w-5 md:h-5 text-emerald-100 group-hover:text-emerald-500 transition-colors" />
                               <ArrowUpRight className="w-3 h-3 md:w-4 md:h-4 text-slate-300" />
                            </div>
                            <div className="text-2xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-emerald-600 to-teal-600 mb-1">50<span className="text-emerald-500 text-lg md:text-2xl align-top">+</span></div>
                            <div className="text-[10px] md:text-sm text-slate-500 font-medium">标准参编单位</div>
                         </div>
                         {/* Stat 4 */}
                         <div className="p-3 md:p-6 bg-white rounded-2xl rounded-br-[2rem] shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-slate-100 hover:-translate-y-1 transition-transform duration-300 group">
                             <div className="flex justify-between items-start mb-2">
                               <Users className="w-4 h-4 md:w-5 md:h-5 text-emerald-100 group-hover:text-emerald-500 transition-colors" />
                               <ArrowUpRight className="w-3 h-3 md:w-4 md:h-4 text-slate-300" />
                            </div>
                            <div className="text-2xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-emerald-600 to-teal-600 mb-1">200<span className="text-emerald-500 text-lg md:text-2xl align-top">+</span></div>
                            <div className="text-[10px] md:text-sm text-slate-500 font-medium">机构参与研讨会</div>
                         </div>
                      </div>
                  </div>
               </div>
               ...
               <div className="lg:col-span-7 flex flex-col gap-4 md:gap-8">
                  ...
                  <div className="group relative bg-white/90 backdrop-blur-sm rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-10 border border-white shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-10px_rgba(16,185,129,0.1)] transition-all duration-500 overflow-hidden">
                     <div className="absolute top-0 right-0 w-24 h-24 md:w-32 md:h-32 bg-emerald-50/50 rounded-bl-[80px] md:rounded-bl-[100px] transition-transform duration-500 group-hover:scale-110 origin-top-right"></div>
                     <div className="relative z-10">
                         <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-6">
                            <div className="w-8 h-8 md:w-12 md:h-12 rounded-xl md:rounded-2xl bg-emerald-100 text-emerald-600 flex items-center justify-center shrink-0">
                                <Award className="w-4 h-4 md:w-6 md:h-6" />
                            </div>
                            <h3 className="text-lg md:text-2xl font-bold text-slate-900">深度参与标准共建</h3>
                         </div>
                         <p className="text-slate-600 leading-relaxed mb-4 md:mb-8 pl-1 text-xs md:text-base line-clamp-2 md:line-clamp-none">
                             GE1OO主导编制了多个对齐国际绿电规范和中国本土行业经验的团体标准。加入GE1OO的单位有机会优先推荐技术骨干参与标准编制。
                         </p>
                         <div className="bg-slate-50/80 rounded-xl md:rounded-2xl p-3 md:p-6 border border-slate-100 space-y-2 md:space-y-3">
                            <div className="flex items-start gap-2 md:gap-3">
                                <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-emerald-500 mt-0.5 shrink-0" />
                                <span className="text-slate-700 font-medium text-[10px] md:text-sm">提升企业技术公信力，确立行业地位</span>
                            </div>
                            <div className="flex items-start gap-2 md:gap-3">
                                <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-emerald-500 mt-0.5 shrink-0" />
                                <span className="text-slate-700 font-medium text-[10px] md:text-sm">衔接国际认证与标准，规避贸易壁垒</span>
                            </div>
                         </div>
                     </div>
                  </div>
                  ...
                  <div className="group relative bg-gradient-to-br from-white to-slate-50/80 backdrop-blur-sm rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-10 border border-white shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-10px_rgba(16,185,129,0.1)] transition-all duration-500">
                     <div className="relative z-10">
                         <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-6">
                            <div className="w-8 h-8 md:w-12 md:h-12 rounded-xl md:rounded-2xl bg-slate-800 text-emerald-400 flex items-center justify-center shrink-0">
                                <Globe className="w-4 h-4 md:w-6 md:h-6" />
                            </div>
                            <h3 className="text-lg md:text-2xl font-bold text-slate-900">强化行业领导力</h3>
                         </div>
                         <p className="text-slate-600 leading-relaxed mb-4 md:mb-8 pl-1 text-xs md:text-base line-clamp-2 md:line-clamp-none">
                         ...
                         {/* Inner Special Box */}
                         <div className="relative overflow-hidden rounded-xl md:rounded-2xl border border-emerald-100 bg-white p-1">
                             <div className="absolute left-0 top-0 bottom-0 w-1 bg-emerald-500"></div>
                             <div className="flex items-center gap-3 md:gap-5 p-3 md:p-5">
                                 <div className="shrink-0 flex flex-col items-center justify-center w-10 h-10 md:w-16 md:h-16 rounded-xl bg-emerald-50 text-emerald-700">
                                     <Award className="w-4 h-4 md:w-6 md:h-6 mb-1" />
                                     <span className="text-[6px] md:text-[10px] font-bold uppercase">Award</span>
                                 </div>
                                 <div>
                                     <div className="text-[10px] md:text-xs font-bold text-emerald-600 mb-0.5 md:mb-1 uppercase tracking-wider">重点推荐</div>
                                     <p className="text-[10px] md:text-sm font-medium text-slate-800 leading-snug">
        ...
        <Section id="join" className="bg-white bg-pattern-waves">
           <div className="max-w-7xl mx-auto w-full flex flex-col justify-center h-full items-center">
              ...
              <div className="text-center mb-8 md:mb-24">
                 <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-6 text-slate-900">
              ...
              {/* Steps Visualization */}
              <div className="w-full relative mb-10 md:mb-20 px-0 md:px-0">
                    ...
                    {[
                      ...
                      { 
                       ...
                       <div key={i} className="flex flex-col items-center text-center group">
                          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full bg-emerald-50/50 border border-emerald-100 shadow-sm flex items-center justify-center mb-4 md:mb-8 group-hover:border-emerald-400 group-hover:shadow-md transition-all duration-300 relative z-10">
                             {step.icon}
                          </div>
                          <h3 className="text-xs md:text-xl font-bold text-slate-900 mb-2 md:mb-4">{step.title}</h3>
              ...
              {/* Downloads Area */}
              <div className="w-full max-w-5xl bg-slate-50 rounded-2xl border border-slate-100 p-5 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
                  ...
                  <div className="flex flex-row gap-2 md:gap-4 w-full md:w-auto">
                     <Button variant="outline" size="sm" className="bg-white hover:bg-emerald-50 border-slate-200 hover:border-emerald-200 text-slate-600 hover:text-emerald-700 flex-1 md:flex-initial text-xs md:text-base">
                        目标框架文档 ↳
                     </Button>
                     <Button variant="outline" size="sm" className="bg-white hover:bg-emerald-50 border-slate-200 hover:border-emerald-200 text-slate-600 hover:text-emerald-700 flex-1 md:flex-initial text-xs md:text-base">
                        技术指南 PDF ↳
        ...
        <Section id="join-form" className="bg-slate-50 bg-pattern-grid">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-12 max-w-7xl mx-auto w-full items-center h-full md:h-auto">
              ...
              <div className="lg:col-span-5 space-y-4 md:space-y-8 order-1 lg:order-1">
                 ...
                 <div className="space-y-2 md:space-y-4 pt-2 md:pt-4 border-t border-slate-200">
                    <div className="flex items-center gap-3 md:gap-4 text-slate-700 p-3 md:p-4 rounded-xl bg-white border border-slate-100 shadow-sm">
                       <MapPin className="w-4 h-4 md:w-5 md:h-5 text-emerald-600"/>
                       <span className="font-medium text-xs md:text-base">北京市西城区</span>
                    </div>
                    <div className="flex items-center gap-3 md:gap-4 text-slate-700 p-3 md:p-4 rounded-xl bg-white border border-slate-100 shadow-sm">
                       <FileText className="w-4 h-4 md:w-5 md:h-5 text-emerald-600"/>
                       <span className="font-medium text-xs md:text-base">contact@ge100.org</span>
                    </div>
                 </div>
              </div>
              ...
              <div className="space-y-4 md:space-y-8 lg:pr-8 order-1 lg:order-1">
                 ...
                 <div className="space-y-2 md:space-y-4">
                    {['行业研讨会', '年度峰会论坛', '跨行业交流会'].map((item, i) => (
                       <div key={i} className="flex items-center p-3 md:p-4 bg-white border border-slate-200 rounded-xl shadow-sm">
                          <div className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-emerald-500 mr-3 md:mr-4"></div>
            ...
            <div className="flex-1 overflow-auto bg-white rounded-xl md:rounded-[2rem] border border-slate-200 shadow-xl custom-scrollbar relative min-h-0">
              <table className="w-full text-left border-collapse min-w-[300px] md:min-w-[600px]">
                <thead className="bg-slate-50/80 backdrop-blur-md sticky top-0 z-10 border-b border-slate-200">
                  <tr>
                    <th className="py-2 md:py-3 px-3 md:px-4 text-[10px] md:text-sm font-bold text-slate-500 uppercase tracking-wider pl-4 md:pl-6">公司名称</th>
                    <th className="py-2 md:py-3 px-3 md:px-4 text-[10px] md:text-sm font-bold text-slate-500 uppercase tracking-wider text-right md:text-left">成员级别</th>
                    <th className="py-2 md:py-3 px-3 md:px-4 text-sm font-bold text-slate-500 uppercase tracking-wider hidden md:table-cell">行业</th>
                    <th className="py-2 md:py-3 px-3 md:px-4 text-sm font-bold text-slate-500 uppercase tracking-wider hidden md:table-cell">总部</th>
                    <th className="py-2 md:py-3 px-3 md:px-4 text-sm font-bold text-slate-500 uppercase tracking-wider text-right pr-6 hidden md:table-cell">目标年份</th>
                  </tr>
                </thead>
                    ...
                    filteredMembers.map((m, i) => (
                      <tr key={i} className="group hover:bg-emerald-50/30 transition-colors cursor-pointer">
                        <td className="py-2 md:py-3 px-3 md:px-4 pl-4 md:pl-6">
                           <div className="font-bold text-slate-900 text-sm md:text-lg group-hover:text-emerald-700 transition-colors">{m.name}</div>
                        ...
                        <td className="py-2 md:py-3 px-3 md:px-4 text-right md:text-left">
                          <span className={`inline-flex items-center px-2 py-0.5 md:px-3 md:py-1 rounded-full text-[10px] md:text-sm font-bold border ${
                        ...
                        <td className="py-3 px-4 pr-6 text-right font-mono font-bold text-slate-900 text-lg group-hover:text-emerald-600 hidden md:table-cell">{m.targetYear}</td>
                      </tr>
                    ))
                  ) : (
                    <tr>
